...
const Articles = (props: TitleProps) => {
  return (
    <>
      ...
      <Container className="mt-4 d-flex flex-column justify-content-center align-items-center align-items-xxl-start">
        <h3 className="ms-2 mb-3 mb-xl-0 news-subtitle py-1">{props.subtitle}</h3>

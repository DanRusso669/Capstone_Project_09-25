...
const AddAnimalPage = () => {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<FormFields>({ defaultValues: emptyAnimal });

  const onSubmit: SubmitHandler<FormFields> = async () => {
    console.log("Dati del form:", emptyAnimal);
    try {
      await toast.promise(
        dispatch(animalCRUDFetch({ animalId: null, method: "POST", animalData: emptyAnimal })).unwrap(),
        {
          ...
          <Row>
            <Form.Group as={Col} xs={12} sm={6} lg={4} controlId="formGridName" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.name = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} lg={4} controlId="formGridAge" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.age = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} lg={3} controlId="formGridSpecies" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.species = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} lg={3} controlId="formGridBreed" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.breed = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} lg={3} controlId="formGridGender" className="mt-3">
              ...
              <Form.Select
                ...
                onChange={e => (emptyAnimal.gender = e.target.value)}
              >
            ...
            <Form.Group as={Col} xs={12} sm={6} lg={3} controlId="formGridGender" className="mt-3">
              ...
              <Form.Select
                ...
                className="border border-dark"
                onChange={e => (emptyAnimal.status = e.target.value)}
              >
            ...
            <Form.Group as={Col} xs={12} sm={6} lg={4} controlId="formGridCity" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.city = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} lg={4} controlId="formGridProvince" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.province = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} lg={4} controlId="formGridRegion" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.region = e.target.value)}
              />
          ...
          <Row>
            <Form.Group as={Col} xs={12} sm={6} controlId="formGridDescription" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.description = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} controlId="formGridClinicalCondition" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.clinicalCondition = e.target.value)}
              />
          ...
          <Row>
            <Form.Group as={Col} xs={12} sm={6} controlId="formGridName" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.userName = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} controlId="formGridSurname" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.userSurname = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} controlId="formGridEmail" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.userEmail = e.target.value)}
              />
            ...
            <Form.Group as={Col} xs={12} sm={6} controlId="formGridPhone" className="mt-3">
              ...
              <Form.Control
                ...
                onChange={e => (emptyAnimal.userPhoneNumber = e.target.value)}
              />
